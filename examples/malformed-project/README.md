...
- `project.json` contains invalid field types, duplicate keys/prefixes, and invalid metadata keys.
...
4. In **Document** tab, confirm a warning banner about `project.json` issues.
